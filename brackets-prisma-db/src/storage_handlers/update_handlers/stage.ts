  ...
  return prisma.stage
    .update({
      ...
      data: {
        ...
        type: value.type ? StageTypeTransformer.to(value.type) : undefined,
        settings: value.settings
          ? {
              update: {
                size: value.settings.size,
                seedOrdering: value.settings.seedOrdering
                  ? value.settings.seedOrdering.map(SeedOrderingTransformer.to)
                  : undefined,
                ...
                roundRobinMode: value.settings.roundRobinMode
                  ? RoundRobinModeTransformer.to(value.settings.roundRobinMode)
                  : undefined,
                ...
                grandFinal: value.settings.grandFinal
                  ? GrandFinalTypeTransformer.to(value.settings.grandFinal)
                  : undefined,
              },
            }
          : undefined,
